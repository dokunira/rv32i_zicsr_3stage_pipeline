...
0000003c <write_tohost>:
  3c:	20302023          	sw	gp,512(zero) # 200 <tohost>
  40:	20002223          	sw	zero,516(zero) # 204 <tohost+0x4>
...
00000048 <reset_vector>:
  ...
  fc:	fff28293          	addi	t0,t0,-1 # 7fffffff <_end+0x7ffffcff>
 ...
 164:	10928293          	addi	t0,t0,265 # b109 <_end+0xae09>
 168:	30229073          	csrw	medeleg,t0
 16c:	30005073          	csrwi	mstatus,0
 170:	00001537          	lui	a0,0x1
 174:	80050513          	addi	a0,a0,-2048 # 800 <_end+0x500>
 178:	30052073          	csrs	mstatus,a0
 17c:	02200513          	li	a0,34
 180:	30352073          	csrs	mideleg,a0
 184:	00000297          	auipc	t0,0x0
 188:	01428293          	addi	t0,t0,20 # 198 <reset_vector+0x150>
 18c:	34129073          	csrw	mepc,t0
 190:	f1402573          	csrr	a0,mhartid
 194:	30200073          	mret
 198:	10017073          	csrci	sstatus,2
 19c:	10416073          	csrsi	sie,2
 1a0:	14416073          	csrsi	sip,2
 1a4:	10500073          	wfi
 1a8:	0ff0000f          	fence
 1ac:	00100193          	li	gp,1
 1b0:	05d00893          	li	a7,93
